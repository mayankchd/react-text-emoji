...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EmojiMarkdown = __webpack_require__(159);

	var _EmojiMarkdown2 = _interopRequireDefault(_EmojiMarkdown);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_EmojiMarkdown2.default, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Emoji = __webpack_require__(160);
	...
	var EmojiMarkdown = function (_Component) {
	  _inherits(EmojiMarkdown, _Component);

	  function EmojiMarkdown(props, context) {
	    _classCallCheck(this, EmojiMarkdown);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EmojiMarkdown).call(this, props, context));
	  ...
	  _createClass(EmojiMarkdown, [{
	    key: 'strToWords',
	    value: function strToWords(str) {
	      var words = [];
	      var lines = str.split('\n');
	      lines.filter(function (line) {
	        return line ? true : false;
	      }).forEach(function (line) {
	        words = words.concat(line.split(' ').filter(function (line) {
	          return line ? true : false;
	        }));
	      });
	      return words;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          this.strToWords(this.state.value).map(function (w, i) {
	            return _react2.default.createElement(_Emoji2.default, { word: w, key: i });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getEmoji = __webpack_require__(161);
	...
	function Emoji(props) {
		var word = props.word;
		var emoji = (0, _getEmoji2.default)(word);
		if (emoji != '') {
			var Style = {
				fontWeight: 'normal',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emojilib = __webpack_require__(162);
	...
	function getEmoji(keyword) {
		...
		if (!keyword || keyword === '' || keyword === 'it') return '';

		var maybeSingular = '';
		if (keyword.length > 2 && keyword[keyword.length - 1] == 's') maybeSingular = keyword.slice(0, keyword.length - 1);
		...
		for (var emoji in _emojilib2.default) {
			var keywords = _emojilib2.default[emoji].keywords;
			if (emoji == keyword || emoji == maybeSingular || emoji == maybePlural || keywords && keywords.indexOf(keyword) >= 0 || keywords && keywords.indexOf(maybeSingular) >= 0 || keywords && keywords.indexOf(maybePlural) >= 0) {

				if (_emojilib2.default[emoji].char) return startPuncs + _emojilib2.default[emoji].char + endPuncs;else return '';
			}
		}
		return '';
	}
